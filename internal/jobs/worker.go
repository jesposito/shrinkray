...
func (w *Worker) processJob(job *Job) {
	...
	result, err := w.transcoder.Transcode(jobCtx, job.InputPath, tempPath, preset, duration, job.Bitrate, job.SubtitleCodecs, w.cfg.SubtitleHandling, job.BitDepth, progressCh)
